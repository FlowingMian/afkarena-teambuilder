...
export const Strength:Attribute = {
  id: 'STRENGTH',
  name: 'Strength',
  iconURL: (size=DEFAULT_SIZE) => getImageIcon('attribute/strength.png', size),
};
export const Intelligence:Attribute = {
  id: 'INTELLIGENCE',
  name: 'Intelligence',
  iconURL: (size=DEFAULT_SIZE) => getImageIcon('attribute/intelligence.png', size),
};
export const Agility:Attribute = {
  id: 'AGILITY',
  name: 'Agility',
  iconURL: (size=DEFAULT_SIZE) => getImageIcon('attribute/agility.png', size),
};
