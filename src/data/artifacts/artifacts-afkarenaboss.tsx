...
const artifactGuide: ArtifactGuide = {
  ...
  artifacts : new Map([
    ...
    [Maulers.Antandra,          {rank1: [Chaos],        rank2: [Grace],         rank3: [Carnage]}],
    ...
    [Dimensionals.Ukyo,         {rank1: [Chaos],        rank2: [Grace],         rank3: [Carnage]}],
    ...
    [Hypogeans.Zolrath,         {rank1: [Carnage],      rank2: [Chaos],         rank3: [Eye]}],
  ]),
};
