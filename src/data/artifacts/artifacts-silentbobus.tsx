...
const artifactGuide: ArtifactGuide = {
  ...
  artifacts : new Map([
    ...
    [Dimensionals.Arthur,         {rank1: [Barricade],    rank2: [Limit],         rank3: [Waistband]}],
    ...
    [Graveborns.Daimon,           {rank1: [Call],         rank2: [Waistband],     rank3: [Limit]}],
    ...
    [Wilders.Gorvo,               {rank1: [Waistband],    rank2: [Grace],         rank3: [Limit]}],
    [Graveborns.Grezhul,          {rank1: [Limit],        rank2: [Chalice],       rank3: [Eye]}],
    [Lightbearers.Gwyneth,        {rank1: [Longbow],      rank2: [Shroud],        rank3: [Eye]}],
    [Lightbearers.Hendrik,        {rank1: [Waistband],    rank2: [Barricade],     rank3: [Limit]}],
    ...
    [Lightbearers.Lucius,         {rank1: [Waistband],    rank2: [Barricade],     rank3: [Limit]}],
    ...
    [Hypogeans.Mezoth,            {rank1: [Waistband],    rank2: [Limit],         rank3: [Barricade]}],
    ...
    [Celestials.Orthos,           {rank1: [Waistband],    rank2: [Chalice],       rank3: [Limit]}],
    ...
    [Lightbearers.Rosaline,       {rank1: [Eye],          rank2: [Blade],         rank3: [Call]}],
    ...
    [Maulers.Skreg,               {rank1: [Waistband],    rank2: [Limit],         rank3: [Chalice]}],
    ...
    [Graveborns.Thoran,           {rank1: [Call],         rank2: [Limit],         rank3: [Waistband]}],
    [Maulers.Tidus,               {rank1: [Shroud],       rank2: [Grace],         rank3: [Eye]}],
    [Graveborns.Torne,            {rank1: [Waistband],    rank2: [Limit],         rank3: [Chalice]}],
    [Dimensionals.Ukyo,           {rank1: [Chaos],        rank2: [Eye],           rank3: [Pauldron]}],
    [Wilders.Ulmus,               {rank1: [Waistband],    rank2: [Limit],         rank3: [Drape]}],
    ...
    [Hypogeans.Zolrath,           {rank1: [Chaos],        rank2: [Pauldron],      rank3: [Eye]}],
  ]),  
};
