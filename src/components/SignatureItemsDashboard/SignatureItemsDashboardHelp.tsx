...
type SignatureItemsDashboardHelpProps = {
  deviceStyle: DeviceStyle;
}
function SignatureItemsDashboardHelp({deviceStyle}:SignatureItemsDashboardHelpProps):JSX.Element {
...
export default SignatureItemsDashboardHelp;
