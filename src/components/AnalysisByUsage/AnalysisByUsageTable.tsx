...
function AnalysisByUsageTable({ usageResult }: AnalysisByUsageTableProps) {
  ...
  function getUsageNumberColor(heroUsageResult:HeroUsageResult):Object {
  ...
  function getFlexNumberColor(heroUsageResult:HeroUsageResult):Object {
  ...
  function getCoreNumberColor(heroUsageResult:HeroUsageResult):Object {
