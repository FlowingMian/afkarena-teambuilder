...
import { Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerHeader, DrawerOverlay, Box, Heading, IconButton, Wrap, WrapItem, useDisclosure } from '@chakra-ui/react';
        ...
        <DrawerContent>
          ...
          <DrawerBody p={1}>
            <Wrap alignItems='start'>
              ...
              {displayArtifact && <WrapItem {...itemStyle} width='21rem' >
